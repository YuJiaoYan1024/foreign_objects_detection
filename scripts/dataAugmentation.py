...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='./dataset/images')
    parser.add_argument('--source_xml_path', type=str, default='./dataset/labels')
    parser.add_argument('--save_img_path', type=str, default='./dataset/Images2')
    parser.add_argument('--save_xml_path', type=str, default='./dataset/Annotations2')
